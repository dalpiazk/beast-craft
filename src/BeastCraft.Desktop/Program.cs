    ...
    public static class Program
    {
        ...
        public static int Main(string[] args)
        {
            ...
            if (options == null)
            {
                ...
                Console.Error.WriteLine("Usage: BeastCraft.Desktop [--screenshot PATH [--turns N] [--skill ID] [--at MS] [--scale K]] [--select-skill N] [--speed S] [--safe-inset L,T,R,B] [--seed S] [--level L] [--enemy-level L] [--encounter ID] [--content DIR] [--effects full|reduced|minimal] [--no-shake] [--no-flashes] [--show-settings]");
                return 2;
            }
